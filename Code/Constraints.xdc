...
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { pin16 }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
...
#set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { pin40 }]; #IO_L5P_T0_34 Sch=pio[40]
